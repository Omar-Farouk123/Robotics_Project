...
def generate_launch_description():
    ...
    mujoco = Node(
        ...
        parameters=[
            ...
            {"joint_command_topic_name": "robot_joint_commands"},
    ...
    movement_node = Node(
        package="mujoco_ros2",
        executable="robotics_workspace/src/mujoco_ros2/src/nodes/Screwdriver_node.py",
        output="screen",
    )
    
    return LaunchDescription([mujoco, coffee_controller, movement_node])